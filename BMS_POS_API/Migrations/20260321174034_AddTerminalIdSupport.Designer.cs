...
namespace BMS_POS_API.Migrations
{
    ...
    [Migration("20260321174034_AddTerminalIdSupport")]
    partial class AddTerminalIdSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BMS_POS_API.Models.AdminSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("LastBackupMethod")
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("PerformanceMetricsEnabled")
                        .HasColumnType("boolean");

                    b.Property<bool>("RequireStrongPins")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("BMS_POS_API.Models.CashSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TerminalId", "SessionDate")
                        .IsUnique()
            ...
            modelBuilder.Entity("BMS_POS_API.Models.Employee", b =>
                {
                    ...
                    b.Property<bool>("MustChangePinOnNextLogin")
                        .HasColumnType("boolean")
                        .HasColumnName("must_change_pin_on_next_login");
            ...
            modelBuilder.Entity("BMS_POS_API.Models.SystemSettings", b =>
                {
                    ...
                    b.Property<decimal>("StockAdjustmentApprovalCostThreshold")
                        .HasColumnType("numeric");

                    b.Property<int>("StockAdjustmentApprovalQuantityThreshold")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BMS_POS_API.Models.CashSession", b =>
                {
                    b.HasOne("BMS_POS_API.Models.Employee", "ClosedByEmployee")
                        .WithMany()
                        .HasForeignKey("ClosedByEmployeeId");

                    b.HasOne("BMS_POS_API.Models.Employee", "OpenedByEmployee")
                        .WithMany()
